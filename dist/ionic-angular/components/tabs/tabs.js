...
var Tabs = /** @class */ (function (_super) {
    ...
    function Tabs(parent, viewCtrl, _app, config, elementRef, _plt, renderer, _linker, keyboard) {
        ...
        if (keyboard && keyboardResizes) {
            keyboard.willHide.pipe(takeUntil(_this._onDestroy)).subscribe(function () {
                _this._plt.timeout(function () { return _this.setTabbarHidden(false); }, 50);
            });
            keyboard.willShow.pipe(takeUntil(_this._onDestroy)).subscribe(function () { return _this.setTabbarHidden(true); });
        }
        return _this;
    }
    /**
    ...
    Tabs.prototype.ngAfterViewInit = function () {
        ...
        if (this.tabsHighlight) {
            this._plt.resize.pipe(takeUntil(this._onDestroy)).subscribe(function () { return _this._highlight.select(_this.getSelected()); });
        }
        this.initTabs();
    };
    /**
