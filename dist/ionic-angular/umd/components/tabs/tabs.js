...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@angular/core", "rxjs", "rxjs/operators", "../app/app", "../../config/config", "../../navigation/deep-linker", "../ion", "../../util/util", "../../platform/keyboard", "../../navigation/nav-controller", "../../navigation/nav-util", "../../navigation/url-serializer", "../split-pane/split-pane", "../../platform/platform", "./tab-highlight", "../../navigation/view-controller"], factory);
    }
    ...
    var Tabs = /** @class */ (function (_super) {
        ...
        function Tabs(parent, viewCtrl, _app, config, elementRef, _plt, renderer, _linker, keyboard) {
            ...
            if (keyboard && keyboardResizes) {
                keyboard.willHide.pipe(operators_1.takeUntil(_this._onDestroy)).subscribe(function () {
                    _this._plt.timeout(function () { return _this.setTabbarHidden(false); }, 50);
                });
                keyboard.willShow.pipe(operators_1.takeUntil(_this._onDestroy)).subscribe(function () { return _this.setTabbarHidden(true); });
            }
            return _this;
        }
        /**
        ...
        Tabs.prototype.ngAfterViewInit = function () {
            ...
            if (this.tabsHighlight) {
                this._plt.resize.pipe(operators_1.takeUntil(this._onDestroy)).subscribe(function () { return _this._highlight.select(_this.getSelected()); });
            }
            this.initTabs();
        };
        /**
