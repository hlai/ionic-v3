...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@angular/core", "@angular/forms", "rxjs", "rxjs/operators", "../app/app", "../../config/config", "../content/content", "../../util/dom", "../../platform/dom-controller", "../../util/form", "../../util/base-input", "../../util/util", "../item/item", "../../platform/platform"], factory);
    }
    ...
    var TextInput = /** @class */ (function (_super) {
        ...
        */
        ...
        TextInput.prototype._enableHideCaretOnScroll = function () {
            ...
            (void 0) /* console.debug */;
            content.ionScrollStart.pipe(operators_1.takeUntil(this._onDestroy))
                .subscribe(function () { return scrollHideCaret(true); });
            content.ionScrollEnd.pipe(operators_1.takeUntil(this._onDestroy))
