        ...
        */
        VirtualScroll.prototype.ngOnChanges = function (changes) {
            if ('virtualScroll' in changes) {
                ...
                if (!util_1.isPresent(this._differ) && util_1.isPresent(value)) {
                    try {
        ...
        VirtualScroll.prototype.ngDoCheck = function () {
            ...
            var changes = util_1.isPresent(this._differ) ? this._differ.diff(this.virtualScroll) : null;
        ...
        VirtualScroll.prototype._stepDOMWrite = function () {
            ...
            // ******** DOM WRITE ****************
            virtual_util_1.writeToNodes(this._plt, nodes, cells, this._recordSize);
            // ******** DOM WRITE ****************
            this._setHeight(virtual_util_1.estimateHeight(this._recordSize, cells[cells.length - 1], this._vHeight, 0.25));
        ...
        VirtualScroll.prototype._stepNoChanges = function () {
            ...
            virtual_util_1.adjustRendered(cells, data);
            var hasChanges = virtual_util_1.populateNodeData(data.topCell, data.bottomCell, diff > 0, cells, records, nodes, this._itmTmp.viewContainer, this._itmTmp.templateRef, this._hdrTmp && this._hdrTmp.templateRef, this._ftrTmp && this._ftrTmp.templateRef);
            if (hasChanges) {
        ...
        VirtualScroll.prototype.scrollEnd = function () {
            ...
            virtual_util_1.populateNodeData(this._data.topCell, this._data.bottomCell, true, this._cells, this._records, this._nodes, this._itmTmp.viewContainer, this._itmTmp.templateRef, this._hdrTmp && this._hdrTmp.templateRef, this._ftrTmp && this._ftrTmp.templateRef);
            // ******** DOM WRITE ***************
